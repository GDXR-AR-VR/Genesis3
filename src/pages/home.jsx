...
export default function Home() {
  ...
  return (
    <div className="home h-screen flex-col justify-center items-center align-middle text-white text-center imgHome ">
      ...
      ></img>
      {scrollPosition < screenHeight-300 &&<div className=" xl:mt-48  mt-20 fixed m-auto w-screen text-7xl sm:text-xl md:text-[100px] lg:text-[150px] xl:text-[200px] parallax align-middle text-center font-[Pricedown]">
        <img
      ...
      <div className="relative register bg-red-600 m-auto lg:w-40 lg:h-20 lg:text-4xl lg:p-6 w-28 h-8 text-2xl p-0.5 mt-20 font-[BerlinSans] font-bold text-center z-30">
        Register
      </div>
