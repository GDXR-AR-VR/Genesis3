export default function PrizeComponent({
  ...
  return (
    <>
      <div
        className={`font-[Pricedown] rounded-[30px]  ${width} ${height} ${color} flex-col items-center justify-center align-middle z-10 mt-5 m-auto drop-shadow-[0_2.2px_2.2px_rgba(0,0,0,0.8)]`}
      >
